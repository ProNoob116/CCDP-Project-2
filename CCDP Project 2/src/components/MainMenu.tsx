  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-black flex items-center justify-center">
      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            className="h-px bg-gradient-to-r from-transparent via-red-500 to-transparent mx-auto w-96"
          />
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ delay: 1.2, duration: 0.8 }}
            className="text-gray-400 text-sm tracking-widest mt-4"
          >
              ...
              >
                ...
                <div className="relative bg-black/95 backdrop-blur-sm px-8 py-5 flex items-center justify-between">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.6, repeat: hoveredButton === button.id ? Infinity : 0 }}
                  >
              ...
              <AnimatePresence>
                {hoveredButton === button.id && (
                  <motion.div
                    ...
                    style={{
                      background: `radial-gradient(circle, ${glowColors[button.glow as keyof typeof glowColors]}, transparent 70%)`,
                    }}
                  />
                )}
              </AnimatePresence>
        ...
        >
          <p className="text-[rgb(203,203,203)] text-xs tracking-widest">
            CCDP10003 PROJECT 2 SUBMISSION
          </p>
          <p className="text-[rgb(197,197,197)] text-xs">
            © By Paul Joseph, Pranav Gandham and Alex Lovering • ALL RIGHTS RESERVED
          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="absolute top-8 left-8 opacity-30">
        <div className="w-16 h-16 border-t-2 border-l-2 border-red-500" />
      </div>
      <div className="absolute top-8 right-8 opacity-30">
        <div className="w-16 h-16 border-t-2 border-r-2 border-blue-500" />
      </div>
      <div className="absolute bottom-8 left-8 opacity-30">
        <div className="w-16 h-16 border-b-2 border-l-2 border-red-500" />
      </div>
      <div className="absolute bottom-8 right-8 opacity-30">
        <div className="w-16 h-16 border-b-2 border-r-2 border-blue-500" />
      </div>
    </div>
  );
}
